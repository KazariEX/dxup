...
const plugin: VueLanguagePlugin<Config> = ({
    ...
    const variableName = "__VLS_layout";
    ...
    return [{
            ...
            sfc.template.ast.children = [{
                ...
                props: [{
                    ...
                    exp: {
                        ...
                        loc: createVirtualLoc(variableName),
                    },
                    modifiers: [],
                    loc: createVirtualLoc(`:is="${variableName}"`),
                }],
                children,
                codegenNode: void 0,
            }];
        ...
        resolveEmbeddedCode(fileName, sfc, embeddedCode) {
            ...
            embeddedCode.content.push(
                `declare const ${variableName}: import("#build/dxup/layouts").Layouts["${layoutName}"];\n`,
            );
        },
    }];
};
